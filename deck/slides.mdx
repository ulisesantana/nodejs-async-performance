...
- [Charla sobre async generators](https://www.youtube.com/watch?v=uTzBHPpMEhA)
- [Guía sobre el Event Loop en Node.js: The Node.js Event Loop, Timers, and process.nextTick()](https://nodejs.org/en/docs/guides/event-loop-timers-and-nexttick/)
- [Artículo sobre gestión de promesas en Node.js](https://www.nearform.com/blog/optimise-node-js-performance-avoiding-broken-promises/)

---

# ¡Gracias!

## [bit.ly/js-day-nodejs-async-performance](https://bit.ly/js-day-nodejs-async-performance)
## [bit.ly/js-day-nodejs-async-performance-transcription](https://bit.ly/js-day-nodejs-async-performance-transcription)
