...
- Uasr Promise.all es muy goloso, por eso tienes que ser consciente de cuantas promesas estás gestionando.
...
## bit.ly/js-day-nodejs-async-performance
## bit.ly/js-day-nodejs-async-performance-transcription
